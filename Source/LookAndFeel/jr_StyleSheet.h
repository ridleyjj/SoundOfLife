...
#include "Resources/PokemonGameBoyFont.h"
...
namespace jr
{
    ...
    {
        static juce::Typeface::Ptr plainFont { juce::Typeface::createSystemTypefaceFor (Resources::PokemonGameBoyFont::PokemonGbRAeo_ttf, Resources::PokemonGameBoyFont::PokemonGbRAeo_ttfSize) };
    }
    ...
    public:
        CustomLookAndFeel()
        {
            setDefaultSansSerifTypeface(StyleSheet::plainFont);
